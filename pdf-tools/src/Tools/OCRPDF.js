...
function OCRPDF() {
  ...
  const handleFileChange = (event) => {
    ...
    if (file && file.type.startsWith("image/jpeg")) {
      ...
      // Handle invalid file type (not JPEG)
  ...
  return (
    <div className="pdf-container">
      ...
      <div className="container">
        <h1>OCR PDF</h1>
        <p>
          Convert non-selectable PDF files into selectable and searchable PDFs
          with high accuracy...
        </p>
        ...
        {previewUrl && (
          <div className="image-preview-container">
            <h2>JPG Preview</h2>
            <img src={previewUrl} alt="JPG Preview" width="300px" height="100%" />
            <br/>
          </div>
        )}
        <br /><br/><br/><br/>
